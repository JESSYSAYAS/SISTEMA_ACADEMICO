      ...
      <div class="main_container">
        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><font color="purple" size="30px" face="Star Wars"> Registros de  matriculas</font></h2>
                    
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" method="POST" action="operaciones/registrar_matricula.php">
                      <div class="form-group">
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">periodo academico :</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="id_periodo_acad" id="id_periodo_acad" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_estudiante['id_genero']; ?>">
                          <option value="">Seleccione</option>
                          <?php
                          $id_periodo_acad_estudiante = $res_b_estudiante['id_periodo_acad'];
                          $buscar_genero = buscarPeriodoAcadById($conexion);
                          while ($res_b_genero = mysqli_fetch_array($buscar_genero)) {
                            $id_periodo_acad = $res_b_genero['id'];
                          ?>
                          <option value="<?php echo $res_b_genero['id']; ?>" 
                          <?php if ($id_periodo_acad_estudiante == $id_periodo_acad) {
                            echo "selected";
                          } ?>
                          ><?php echo $res_b_genero['periodo_academico']; ?></option>
                          <?php
                          };
                          ?>
                        </select>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">programacion unidad:
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="id_programacion_ud" id="id_programacion_ud" class="form-control col-md-7 col-xs-12">
                          <option value="">Seleccione</option>
                          <?php
                          $buscar_sem = buscarprogramacion_unidad_didactica($conexion);
                          while ($res_b_sem = mysqli_fetch_array($buscar_sem)) {
                          ?>
                          <option value="<?php echo $res_b_sem['id']; ?>"><?php echo $res_b_sem['id']; ?></option>
                          <?php
                          };
                          ?>
                        </select>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">estudiantes:
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="estudiante" id="estudiante" class="form-control col-md-7 col-xs-12">
                          <option value="">Seleccione</option>
                          <?php
                          $buscar_sem = buscarUsuarioEstudianteById($conexion);
                          while ($res_b_sem = mysqli_fetch_array($buscar_sem)) {
                          ?>
                          <option value="<?php echo $res_b_sem['id']; ?>"><?php echo $res_b_sem['id']; ?></option>
                          <?php
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" name="fecha_reg" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
