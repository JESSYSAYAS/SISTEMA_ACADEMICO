                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right">
                      <li>
                        <a href="docentes.php" class="btn btn-success">Agregar Nuevo</a>
                      </li>
                    </ul>
                  ...
                  <div class="x_content">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                        $b_estudiantes = buscarDocente($conexion);
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="operaciones/eliminar_docentes.php?id=<?php echo $res_b_estudiantes['id']; ?>" class="btn btn-danger">Eliminar</a>
                          </td>
                        </tr>
                        <?php
                        }
