...
<head>
	...
	<title>Registrar periodo académico | </title>
    ...
    <link rel="shortcut icon" href="./img/logo.png" width="50px">
								...
								<div class="x_title">
									...
									<div class="row">
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="x_panel">
												<div class="x_title">
													<h2><font color="purple" size="30px" face="Star Wars">Registrar Periodo Academico</font><small></small></h2>
													<div class="clearfix"></div>
												</div>
												<div class="x_content">
													<form class="form-horizontal form-label-left" action="./operaciones/registrar_presente_periodo.php" method="POST" id="formulario_docente">	
														<div class="item form-group">
															<label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Semestre<span class="required">:</span>
															</label>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<select type="text" id="director" name="semestre" class="form-control col-md-7 col-xs-12">
																	<option>Seleccionar semestre</option>
																	<?php
																	$buscar_periodo = buscarPeriodoAcademico($conexion);
																	while ($res_b_periodo = mysqli_fetch_array($buscar_periodo)) {
																	?>
																		<option value='<?php echo $res_b_periodo['id'] ?>'> 
                                                                        <?php echo $res_b_periodo['nombre'] ?></option>
																	<?php
																	};
																	?>
																</select>
