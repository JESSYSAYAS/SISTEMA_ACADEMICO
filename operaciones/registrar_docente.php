...
if ($c_r_b_docente == 0) {//validamos que no haya registros en la base de datos
  $insertar = "INSERT INTO docente (dni,apellidos_nombres,fecha_nac,direccion,correo,telefono,id_genero,nivel_educacion,cond_laboral,id_cargo) VALUES ('$dni', '$apellidos_nombres','$fecha_nac','$direccion','$correo','$telefono','$id_genero','$nivel_educacion','$cond_laboral','$id_cargo')";//consulta
